...
namespace CocaineCrackDown {
    public partial class NätVärd
    {
        ...
        private class Player {
            ...
            /// <summary>
            /// This disconnects the client, even if no message from him within a certain period of time and not been reset value.
            /// </summary>
            ...
            public static void Update() {
                ...
                if (Network.Server.ConnectionsCount == players.Count)  {
                    for ( MängdSpelare = 0; MängdSpelare < players.Count; MängdSpelare++) {
                        ...
                        Network.outmsg.Write(players[MängdSpelare].Namn);
                        Network.outmsg.Write((int)players[MängdSpelare].Positionen.X);
                        Network.outmsg.Write((int)players[MängdSpelare].Positionen.Y);
