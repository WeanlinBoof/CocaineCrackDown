...
namespace RedGrin.Interfaces
{
    ...
    {
        private const int ClientIdBitOffset = 64 - 8;
        ...
        public static ulong PackUniqueId(this byte clientId, uint entityId)
        {
        ...
        public static byte UnpackClientId(this ulong packedId)
        {
        ...
        public static uint UnpackEntityId(this ulong packedId) {
